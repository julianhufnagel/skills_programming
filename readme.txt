...
This is an application to check weather every city around the world.
...
After having this done, the streamlit app can be opened with the command line "streamlit run app.py".
...
The project shows a selection of possible features for a weather app. It can be extended by visualizations of further weather data, e.g. snow or precipitation in general.
